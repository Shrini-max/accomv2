...
export async function allotMessCard(
  ...
  try {
    ...
    return { success: true, message: "Accom card allotted successfully!", student: updatedStudent };
  } catch (error: unknown) {
    ...
    return { success: false, message: "Failed to allot accom card. Database error." };
  }
}
...
export async function revokeMessCard(
  ...
  try {
    ...
    if (!student.messCardSerialNumber) {
      return { success: false, message: "No accom card is currently allotted to this student." };
    }
    ...
    return { success: true, message: "Accom card revoked successfully!", student: updatedStudent };
  } catch (error) {
    console.error("Error revoking mess card:", error);
    return { success: false, message: "Failed to revoke accom card. Database error." };
  }
}
...
export async function generateAllottedStudentsCSV(
  ...
  try {
    ...
    const csvData = students.map((student) => ({
      ...
      "Accom Card Serial No.": student.messCardSerialNumber,
