    ...
    <div className="container mx-auto p-4 md:p-8 max-w-3xl">
      ...
      <Card className="border-destructive/30">
        <CardHeader>
          ...
          <CardDescription>
            Permanently delete all student records including mess card allocations. Cannot be undone.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <AlertDialog>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This permanently deletes every student record and all mess card allocations.
